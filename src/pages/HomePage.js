...
<Suspense fallback={<Skeleton  sx={{ bgcolor: '#68E86D', width: '100%' }}
        variant="rectangular"
...
<NavBar />
    ...
    <Element name='section-banner'>
      <Suspense fallback={<div className='banner_skeleton'> 
      <Skeleton  sx={{ bgcolor: '#FCE588', width: '90%', margin:'0 auto' }}
        variant="rectangular"
    ...
    <Suspense fallback={ <div className='steps_skeleton'>
    <div style={{}}>
    <Skeleton variant="text" animation="wave"  sx={{ fontSize: '1rem', width:'40vh' }} />
...
<Suspense fallback={<div className='product_skeleton'>
    ...
    <Suspense fallback={<div className='faq_skeleton' >
    <Skeleton sx={{ height: 100, width:'60%', backgroundColor:'#FCE588', margin:'0 auto', borderRadius:'10px' }} animation="wave" variant="rectangular" />
...
<Element name='section-itemscroll'>
  <Suspense fallback={<div className='item_skeleton' ><Skeleton variant="rectangular" animation="wave"  height={50} style={{ width:'100%', backgroundColor:'#3525E6'}} /></div>}>
     <ItemScroll/>
      </Suspense>
   </Element>
